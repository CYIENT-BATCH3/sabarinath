 ...
 *
 * start 
 * configure the registers for input output and  spi register sspstat and sspcon
 * connect 2 push button
 * and transmit the data through spi communication according to the push button pressed
 * 
 * 
 * Created on September 15, 2022, 11:40 AM
 */
...
void main(void)
{
    ...
    {   
         ...
         if(SSPBUF>0)                           //if value in sspbuf is greater than 0 then assighn value in SSPBUF to PORTB
            PORTB = SSPBUF; 
         __delay_ms(200);
